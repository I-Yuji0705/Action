...
<member name="M:PlayerInversion.#ctor(Keyboard*,Player*)" decl="false" source="c:\users\student\desktop\action\action\action\playerinversion.cpp" line="4">
<summary>
<para>コンストラクタ</para>
<para>追加でキーが押されているか確認するKeyboardクラスを取得する</para>
</summary>
</member>
<member name="M:PlayerInversion.Do" decl="false" source="c:\users\student\desktop\action\action\action\playerinversion.cpp" line="12">
<summary>
<para>行動処理</para>
