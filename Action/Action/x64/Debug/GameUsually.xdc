...
<member name="M:GameUsually.#ctor(Keyboard*,IGameStateChanger*)" decl="false" source="c:\users\student\desktop\action\action\action\gameusually.cpp" line="6">
<summary>
<para>コンストラクタ</para>
<para>ゲームの通常時に表示する字幕の生成</para>
</summary>
</member>
<member name="M:GameUsually.Update" decl="false" source="c:\users\student\desktop\action\action\action\gameusually.cpp" line="19">
<summary>
<para>更新処理</para>
