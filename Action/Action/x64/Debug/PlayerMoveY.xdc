<?xml version="1.0"?><doc>
<members>
<member name="M:PlayerMoveY.#ctor(Keyboard*,Sound*,Collision*,Player*,PlayerHit*)" decl="false" source="c:\users\yu-rei\music\action\action\action\playermovey.cpp" line="6">
<summary>
<para>コンストラクタ</para>
...
<member name="M:PlayerMoveY.Do" decl="false" source="c:\users\yu-rei\music\action\action\action\playermovey.cpp" line="21">
<summary>
<para>行動処理</para>
...
<member name="M:PlayerMoveY.MoveY(System.Single)" decl="false" source="c:\users\yu-rei\music\action\action\action\playermovey.cpp" line="43">
<summary>
<para>Y軸の移動処理</para>
