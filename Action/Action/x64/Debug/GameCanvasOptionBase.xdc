...
<member name="M:GameCanvasOptionBase.#ctor(Keyboard*,IGameStateChanger*)" decl="false" source="c:\users\student\desktop\action\action\action\gamecanvasoptionbase.cpp" line="3">
<summary>
<para>コンストラクタ</para>
