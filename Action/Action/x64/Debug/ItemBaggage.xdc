...
<member name="M:ItemBaggage.#ctor(Item*)" decl="false" source="c:\users\student\desktop\action\action\action\itembaggage.cpp" line="3">
<summary>
<para>コンストラクタ</para>
</summary>
</member>
<member name="M:ItemBaggage.Do" decl="false" source="c:\users\student\desktop\action\action\action\itembaggage.cpp" line="9">
<summary>
<para>行動処理</para>
