...
<member name="M:Game.#ctor(Keyboard*,Sound*,ISceneChanger*)" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="12">
<summary>
<para>コンストラクタ</para>
<para>最初に表示する字幕とステージを管理するクラスの生成</para>
</summary>
</member>
<member name="M:Game.Initialize" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="21">
<summary>
<para>初期化処理</para>
<para>字幕とステージの初期化処理を行う</para>
</summary>
</member>
<member name="M:Game.Update" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="30">
<summary>
<para>更新処理</para>
...
<member name="M:Game.Draw" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="43">
<summary>
<para>描写処理</para>
<para>字幕とステージの描写処理を行う</para>
</summary>
</member>
<member name="M:Game.Finalize" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="52">
<summary>
<para>終了処理</para>
<para>字幕とステージの終了処理を行う</para>
</summary>
</member>
<member name="M:Game.StartBgm" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="61">
<summary>
<para>ゲーム画面のBGMを再生する</para>
</summary>
</member>
<member name="M:Game.UpdateNextState" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="68">
<summary>
<para>nextstate_が変更されていた場合、nextstate_の値によって対応する処理を行う</para>
</summary>
</member>
<member name="M:Game.ChangeState(GameState)" decl="false" source="c:\users\student\desktop\action\action\action\game.cpp" line="107">
<summary>
