...
<member name="M:Camera.#ctor(std.vector&lt;Object**,std.allocator&lt;Object**&gt;&gt;*,Collision*)" decl="false" source="c:\users\student\desktop\action\action\action\camera.cpp" line="6">
<summary>
<para>コンストラクタ</para>
...
<member name="M:Camera.Initialize" decl="false" source="c:\users\student\desktop\action\action\action\camera.cpp" line="18">
<summary>
<para>初期化処理</para>
<para>ステージの右端、左端、画面の中央に描写するPlayerのポインタの取得</para>
</summary>
</member>
<member name="M:Camera.Update" decl="false" source="c:\users\student\desktop\action\action\action\camera.cpp" line="28">
<summary>
<para>更新処理</para>
