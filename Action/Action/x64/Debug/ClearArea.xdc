...
<member name="M:ClearArea.Initialize" decl="false" source="c:\users\student\desktop\action\action\action\cleararea.cpp" line="19">
<summary>
<para>初期化処理</para>
<para>プレイヤーのポインタの取得</para>
</summary>
</member>
<member name="M:ClearArea.Update" decl="false" source="c:\users\student\desktop\action\action\action\cleararea.cpp" line="28">
<summary>
<para>更新処理</para>
...
<member name="M:ClearArea.Draw" decl="false" source="c:\users\student\desktop\action\action\action\cleararea.cpp" line="52">
<summary>
<para>描写処理</para>
<para>このObject内が他のObjectで満たされているかを確認する</para>
<para>満たされている場合、音楽を鳴らし、playerにクリア時の処理を行わせる</para>
