...
TitleDelete::TitleDelete(Keyboard* keyboard, ITitleStateChanger* statechanger) :TitleCanvasOptionBase(keyboard,statechanger){
	optionData_.push_back((OptionDataBase*)new TitleOptionData(300, 350, "はい", GetColor(0, 0, 0),statechanger, Title_Exit));
	optionData_.push_back((OptionDataBase*)new TitleOptionData(300, 400, "いいえ", GetColor(0, 0, 0),statechanger, Title_Usually));
